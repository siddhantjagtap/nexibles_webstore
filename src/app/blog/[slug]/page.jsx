...
return (
  <div className="[&>nav]:!bg-white">
    ...
    <div className="relative w-full mx-auto md:mt-8 mt-[7rem]">
      ...
      <div className="px-4 sm:px-8 md:px-16 lg:px-32">
        ...
        {currentBlog.introduction && (
          <div className="mt-8">
            <p className="text-black leading-relaxed font-gotham-light">
              {currentBlog.introduction}
            </p>
          </div>
        )}
        ...
        <div className="mt-4 space-y-4">
          {currentBlog.sections?.map((section) => (
            <div key={section.heading} className="space-y-2 ">
              <h2 className="text-[#db5c3c] text-xl font-gotham-rounded-bold">
                {section.heading}
              </h2>
