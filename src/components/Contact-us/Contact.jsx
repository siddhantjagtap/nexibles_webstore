...
function Contact() {
    ...
    return (
        <div className="md:mt-32 flex mb-4 gap-6 flex-col md:flex-row justify-between  p-6 border rounded-3xl border-[#197d8e] max-w-5xl ">
            ...
            <div className="bg-orange-100 p-6 rounded-3xl md:w-1/2 w-full ">
                ...
                <div className='mb-4'>
                    ...
                    <p className='text-gray-700 font-gotham-bold'>+91 9821045101</p>
