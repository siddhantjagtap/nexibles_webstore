...
const PopularcardDetail = () => {
    ...
    const { popularproductId } = useParams();
                ...
                <div className="flex mx-20">
                    ...
                    <div className="w-1/2 py-6">
                        <div className="text-blue-1 font-bold">
                            <h1>Popular Product Details</h1>
                            <p>Product ID: {popularproductId}</p>
                        ...
                        <div className="mt-4">
                            <select className="border border-blue-1 text-blue-1  rounded px-4 w-80 outline-none py-2">
                        ...
                        <div className="py-4 ">
                            <button className="bg-blue-3 px-4 py-2 w-96 text-white mb-4">Browse Design <br />Choose one of our Templates</button>
                            <button className="bg-white-2 px-4 py-2 w-96 text-blue-1">Upload Design <br />Have a Design? Upload and edit it</button>
                        </div>
                    </div>
                </div>
            </div>
