...
//   return (
//     <div
//       className={`relative flex flex-col items-center ${backgroundColor} rounded-lg overflow-visible shadow-lg p-6 w-full md:w-[250px] lg:w-[280px] xl:w-[300px] h-[350px] md:h-[300px] lg:h-[300px] xl:h-[500px]`}
//     >
//       <div className="absolute top-[-50px] left-1/2 transform -translate-x-1/2 z-10">
//         <div className="w-24 h-24 md:w-32 md:h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 rounded-full bg-white p-2 flex items-center justify-center">
//           <Image
//             src={imageSrc}
//             alt={title}
//             width={300}
...
//         </div>
//       </div>
//       <div className="pt-20 pb-6 text-center flex flex-col justify-between h-full">
...
//   return (
//     <div className="bg-[#464087] relative overflow-hidden">
//       <div className="absolute right-0 top-0 ml-auto h-full w-auto">
//         <Image
//           src={HomepageArch1}
//           alt="Decorative Arch"
//           layout="intrinsic"
...
//               {
//                 bgColor: "#9187a6",
//                 text: `"These pouches were perfect for our Diwali gift hampers. The
//                    option to personalize each one made our gifts stand out and
//                    brought smiles all around."`,
//                 name: "- Ashish W",
//               },
//               {
//                 bgColor: "#f7eee5",
//                 text: `"I used these pouches for wedding favors and they were a hit!
//                    It looked great with our pictures on the pouch, the guests got
//                    to take home a cherished personalised gift."`,
//                 name: "- Disha S",
//               },
//               {
//                 bgColor: "#9187a6",
//                 text: `"I gave my family these pouches filled with gourmet coffee &
//                   chocolates. The quality & easy customization was top-notch. It
//                    made the gifts more memorable!"`,
//                 name: "- Prasad N",
//               },
//               {
//                 bgColor: "#f7eee5",
//                 text: `"The Nexipouches were fantastic for our baby shower return
//                    gifts. They were stylish, durable & we got to give some cute
//                    gifts to our guests."`,
//                 name: "- Grishma C",
//               },
...
//                 <div
//                   className={`bg-[${testimonial.bgColor}] p-6 rounded-3xl shadow-lg mx-auto max-w-sm flex-1`}
//                 >
//                   <p className="text-black text-base">{testimonial.text}</p>
...
//         <div className="container mx-auto px-4 overflow-visible">
//           <div className="flex items-center justify-center mb-12">
//             <h2 className="text-3xl md:text-4xl font-bold text-yellow-400 mr- mt-12">
//               Blogs
//             </h2>
//             <Image
//               src="/Home/Blog Title Illustration.svg"
...
//           </div>
//           <div className="flex items-center justify-center mt-8">
//             <button className="bg-yellow-400 px-4 py-2 rounded-full font-bold text-xl md:text-2xl text-[#464087] hover:bg-yellow-300 transition duration-300">
//               Show More
//             </button>
//           </div>
//         </div>
