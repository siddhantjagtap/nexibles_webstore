  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-3xl px-4 md:px-6 lg:px-8">
        <div className="items-center justify-center text-center pt-16 md:pt-32 gap-6 md:gap-8">
          ...
          <div className="max-w-4xl text-white text-center font-gotham-medium md:mt-8 ">
        ...
        <div className="relative flex flex-col items-center text-center py-8 md:py-8">
          <div className="max-w-4xl text-white">
            <h2 className="text-base md:text-xl lg:text-xl mb-2 ">
              {`By Nexibles`}
            </h2>
            <p className="text-base md:text-xl lg:text-xl leading-snug mb-2">
              {`Our parent brand,`}
            ...
            <p className="text-base md:text-xl lg:text-xl leading-snug mb-4 ">
              {`By Nexibles Our parent brand, NEXt generation flexIBLES, is taking flexible packaging to the next level.
