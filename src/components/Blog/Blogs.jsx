...
//         <div className="flex flex-col flex-grow justify-between">
//           <div className="text-center md:mt-4 px-2">
//             <h3 className="text-white text-sm md:text-lg mb-2 md:mb-4">{title}</h3>
//           </div>
//           <div className="text-center">
//             <a
//               href={readMoreLink}
...
//           breakpoints={{
//             640: {
//               slidesPerView: 1, // Still show 1 card for smaller screens
//             },
//             1024: {
//               slidesPerView: 4, // Show 4 cards on desktop
//             },
//           }}
//           className="flex justify-center mt-8" // Center the card in Swiper
//         >
//           {blogPosts.map((post, index) => (
//             <SwiperSlide key={index}>
//               <div className="flex justify-center">
