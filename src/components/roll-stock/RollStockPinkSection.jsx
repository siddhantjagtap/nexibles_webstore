...
import RollstockData from './RollstockData';

const RollStockPinkSection = () => {
  const { imgsrc, alt, width, height } = RollstockData[0];
  return (
    <section className="bg-[#d285a9] py-24">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 px-4">
          <h2 className="text-4xl font-bold text-white mb-4 ml-6">Nexi™ Roll stock</h2>
...
export default RollStockPinkSection;
