...
import { LabelsViewOthercategoriesData } from './LabelsViewOtherCategoriesData';

const LabelsViewOtherCategories = () => {
  return (
    <section className="bg-[#d285a9] py-16">
      <div className="container mx-auto text-left px-4 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {LabelsViewOthercategoriesData.map((category) => (
            <div key={category.id} className="flex flex-col items-center p-4 rounded-lg">
              <div className="relative w-full h-full mb-4"> {/* Consistent height */}
                <img
                  src={category.image}
                  alt={category.name}
...
export default LabelsViewOtherCategories;
