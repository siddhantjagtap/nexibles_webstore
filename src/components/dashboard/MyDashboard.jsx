...
const MyDashboard = ({ savedAddresses }) => {
  ...
  return (
    <div className="bg-white py-10 md:py-20 mt-4 md:mt-10 px-4 md:px-10">
      ...
      <div className="border border-[#197d8e] rounded-3xl mb-8">
        <div className="border-b border-[#197d8e] flex justify-between items-center p-4 md:p-6">
          <div className="text-[#db5c3c] font-semibold text-lg md:text-xl">
            Profile Details
          </div>
        ...
        savedAddresses.data.length > 0 && (
          <div className="border border-[#197d8e] rounded-3xl">
            ...
            <div className="flex justify-center pb-6">
              <Link
                href="/all-addresses"
                className="bg-[#db5c3c] text-white font-bold rounded-full px-6 py-3 text-sm md:text-base"
              >
                View Addresses
              </Link>
            </div>
