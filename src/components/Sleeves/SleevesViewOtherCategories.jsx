...
import { sleevescategoriesData } from './SleevesViewOtherCategoriesData.js'; // Adjust the import path if necessary

const SleevesViewOtherCategories = () => {
  return (
    <section className="bg-[#d285a9] py-16">
      <div className="container mx-auto text-left px-4 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {sleevescategoriesData.map((category) => (
            <div key={category.id} className="flex flex-col items-center p-4 rounded-lg ">
              <div className="relative w-full h-full mb-4"> {/* Define a consistent height */}
                <img
                  src={category.image}
                  alt={category.name}
...
export default SleevesViewOtherCategories;
