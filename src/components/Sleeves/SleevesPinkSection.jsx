...
import SleevesData from './SleevesData';

const SleevesPinkSection = () => {
  // Destructure the first item from SleevesData
  const { imgsrc, alt, width, height } = SleevesData[0];
    ...
    <section className="bg-[#d285a9] py-24">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 px-4">
          ...
          <button className="ml-6 bg-black text-white rounded-md border-[3px] border-white py-2 px-4">
            Request A Quote
          </button>
        </div>
...
export default SleevesPinkSection;
