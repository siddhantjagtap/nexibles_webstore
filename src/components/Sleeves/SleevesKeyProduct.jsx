...
import SleeveKeyProductData from './SleevesKeyProductData.js';

const SleeveKeyProduct = () => {
  return (
    <section className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SleeveKeyProductData.map((feature, index) => (
       ...
       <div className="container mx-auto text-left px-4 lg:px-10 mt-12">
        ...
        <div className="flex justify-center">
          <button className="px-6 py-2 bg-black text-white rounded-md border-[3px] border-white-2">
            Request A Quote
          </button>
        </div>
      </div>
...
export default SleeveKeyProduct;
